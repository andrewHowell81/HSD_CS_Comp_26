...
## Documentation
All code must be well documented. This means:
- Comments before functions to describe purpose
- Comments at the top of each file to describe purpose
...
a Microsoft Word, but for coding! Follow this download link to get started.

Download Link: https://code.visualstudio.com/download

### HTML and CSS
HTML and CSS are two programming languages that are foundational to web developemnt. Using these two languages you can get started making websites. I would recommend understanding the basics of HTML and CSS before you get any further into development. 

Here is a great tutorial to get started: https://www.youtube.com/watch?v=HGTJBPNC-Gw

### JavaScript
JavaScript is a language that allows your website to be interactive. So when you click a button on your webpage, something happens. Check out the tutorial below for an intro into JavaScript, and the last section of the video will teach you how to use JavaScript in an HTML file.

JavaScript tutorial: https://www.youtube.com/watch?v=xKOyDDuQSVY

### Github
Github is the website you are currently on. It is where programmers store their code and it allows for easy collaboration with your team members. It is also how you are required to submit your code. You must make a repository with at least 3 commits and submit the link as described in the rules.

Here are some instruction on how to get started with github: https://www.youtube.com/watch?v=HGTJBPNC-Gw
